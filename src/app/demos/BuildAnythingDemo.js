      ...
      <div className='w-6/12 mx-auto'>
        <div className='flex'>
          <div className='flex-none w-48 relative'>
            <img
              src='assets/images/classic-utility-jacket.jpg'
              alt=''
          ...
          <form className='flex-auto p-6'>
            ...
            <div className='flex items-baseline mt-4 mb-6'>
              <div className='space-x-2 flex'>
                ...
                <label>
                  <input className='w-9 h-9 flex items-center justify-center' name='size' type='radio' value='s' />S
                </label>
                <label>
                  <input className='w-9 h-9 flex items-center justify-center' name='size' type='radio' value='m' />M
                </label>
                <label>
                  <input className='w-9 h-9 flex items-center justify-center' name='size' type='radio' value='l' />L
                </label>
                <label>
...
export default BuildAnythingDemo
